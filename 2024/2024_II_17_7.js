...
const txt = createText((B.X()+M.X())/2, B.Y()+0.5, '4cm^2', 12, true)   


const trapezium = createPolygon([H, M,C,G], {
    fillColor: '#305FB3', fillOpacity:0.6
});

const triangle_2 = createPolygon([A,B,H], {
    fillColor: '#8839C4', fillOpacity:0.6
});

const txt3 = createText(A.X()+0.2, (A.Y()+B.Y())/2, '16cm^2', 12, true)   

const txt4 = createText((C.X()+H.X())/2, (C.Y()+G.Y())/2, '16cm^2', 12, true)   
